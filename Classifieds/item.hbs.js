var item = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "                <p><a href=\""
    ...
    + "\" title=\"Edit Item\" class=\"btn btn-primary\">Edit</a></p>\r\n";
  ...
  return "<!-- item "
    ...
    + ((stack1 = helpers['if'].call(depth0,((stack1 = (depth0 != null ? depth0.Context : depth0)) != null ? stack1.IsEditable : stack1),{"name":"if","hash":{},"fn":this.program(1, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "                <p class=\"theme\">\r\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.Category : depth0),{"name":"each","hash":{},"fn":this.program(3, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "                </p>\r\n            </div>\r\n        </div>\r\n        \r\n\r\n    </div>\r\n\r\n</div>\r\n";
