var template = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "                <p><a href=\""
    + this.escapeExpression(this.lambda(((stack1 = (depth0 != null ? depth0.Context : depth0)) != null ? stack1.AddUrl : stack1), depth0))
    + "\" title=\"Edit Item\" class=\"btn btn-primary\">Add</a></p>\r\n";
